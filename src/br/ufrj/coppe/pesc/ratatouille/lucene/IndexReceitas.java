...
public class IndexReceitas {
	...
	public static String PATH_INDEX = "/home/carlos/Temp/lucene-data/";
	...
	static void indexaReceita(IndexWriter writer, Receita receita)
		...
		Field fieldIngredientes = new TextField(FIELD_INGREDIENTES, receita.getTextoIngredientes(), Field.Store.NO);
		fieldIngredientes.setBoost(0.5f);
		doc.add(fieldIngredientes);
		
		Field linkField = new TextField(FIELD_LINK, receita.getUrl(), Field.Store.YES);
		doc.add(linkField);
